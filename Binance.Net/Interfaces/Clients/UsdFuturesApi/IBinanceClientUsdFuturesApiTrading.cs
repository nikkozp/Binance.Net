...
namespace Binance.Net.Interfaces.Clients.UsdFuturesApi
{
    ...
    public interface IBinanceClientUsdFuturesApiTrading
    {
        ...
        Task<WebCallResult<BinanceFuturesUsdtPlacedOrder>> PlaceOrderAsync(
            string symbol,
            OrderSide side,
        ...
        Task<WebCallResult<IEnumerable<CallResult<BinanceFuturesUsdtPlacedOrder>>>> PlaceMultipleOrdersAsync(
        ...
        Task<WebCallResult<BinanceFuturesUsdtOrder>> GetOrderAsync(string symbol, long? orderId = null, string? origClientOrderId = null, long? receiveWindow = null, CancellationToken ct = default);
        ...
        Task<WebCallResult<BinanceFuturesUsdtCancelOrder>> CancelOrderAsync(string symbol, long? orderId = null, string? origClientOrderId = null, long? receiveWindow = null, CancellationToken ct = default);
        ...
        /// <param name="ct">Cancellation token</param>
        /// <returns>Id's for canceled order</returns>
        Task<WebCallResult<IEnumerable<CallResult<BinanceFuturesUsdtCancelOrder>>>> CancelMultipleOrdersAsync(string symbol, List<long>? orderIdList = null, List<string>? origClientOrderIdList = null, long? receiveWindow = null, CancellationToken ct = default);
        ...
        /// <param name="ct">Cancellation token</param>
        /// <returns>The specific order</returns>
        Task<WebCallResult<BinanceFuturesUsdtOrder>> GetOpenOrderAsync(string symbol, long? orderId = null, string? origClientOrderId = null, long? receiveWindow = null, CancellationToken ct = default);
        ...
        Task<WebCallResult<IEnumerable<BinanceFuturesUsdtOrder>>> GetOpenOrdersAsync(string? symbol = null, int? receiveWindow = null, CancellationToken ct = default);
        ...
        Task<WebCallResult<IEnumerable<BinanceFuturesUsdtOrder>>> GetOrdersAsync(string symbol, long? orderId = null, DateTime? startTime = null, DateTime? endTime = null, int? limit = null, int? receiveWindow = null, CancellationToken ct = default);
        ...
        Task<WebCallResult<IEnumerable<BinanceFuturesUsdtOrder>>> GetForcedOrdersAsync(string? symbol = null,
