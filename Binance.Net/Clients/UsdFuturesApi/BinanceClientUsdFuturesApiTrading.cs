...
namespace Binance.Net.Clients.UsdFuturesApi
{
    ...
    public class BinanceClientUsdFuturesApiTrading : IBinanceClientUsdFuturesApiTrading
    {
        ...
        /// <inheritdoc />
        public async Task<WebCallResult<BinanceFuturesUsdtPlacedOrder>> PlaceOrderAsync(
            string symbol,
            ...
            CancellationToken ct = default)
        {
            ...
            if (!rulesCheck.Passed)
            {
                ...
                return new WebCallResult<BinanceFuturesUsdtPlacedOrder>(new ArgumentError(rulesCheck.ErrorMessage!));
            }
            ...
            var result = await _baseClient.SendRequestInternal<BinanceFuturesUsdtPlacedOrder>(_baseClient.GetUrl(newOrderEndpoint, api, "1"), HttpMethod.Post, ct, parameters, true).ConfigureAwait(false);
            if (result)
                _baseClient.InvokeOrderPlaced(new OrderId
                {
                    SourceObject = result.Data,
                    Id = result.Data.OrderId.ToString(CultureInfo.InvariantCulture)
                });
            return result;
        }
        ...
        /// <inheritdoc />
        public async Task<WebCallResult<IEnumerable<CallResult<BinanceFuturesUsdtPlacedOrder>>>> PlaceMultipleOrdersAsync(
            ...
            CancellationToken ct = default)
        {
            ...
            if (_baseClient.Options.UsdFuturesApiOptions.TradeRulesBehaviour != TradeRulesBehaviour.None)
            {
                foreach (var order in orders)
                {
                    ...
                    {
                        _log.Write(LogLevel.Warning, rulesCheck.ErrorMessage!);
                        return new WebCallResult<IEnumerable<CallResult<BinanceFuturesUsdtPlacedOrder>>>(new ArgumentError(rulesCheck.ErrorMessage!));
                    }
            ...
            var response = await _baseClient.SendRequestInternal<IEnumerable<BinanceFuturesUsdtMultipleOrderPlaceResult>>(_baseClient.GetUrl(multipleNewOrdersEndpoint, api, "1"), HttpMethod.Post, ct, parameters, true, weight: 5).ConfigureAwait(false);
            if (!response.Success)
                return response.As<IEnumerable<CallResult<BinanceFuturesUsdtPlacedOrder>>>(default);

            var result = new List<CallResult<BinanceFuturesUsdtPlacedOrder>>();
            foreach (var item in response.Data)
            {
                result.Add(item.Code != 0
                    ? new CallResult<BinanceFuturesUsdtPlacedOrder>(new ServerError(item.Code, item.Message))
                    : new CallResult<BinanceFuturesUsdtPlacedOrder>(item));
            }
        ...
        /// <inheritdoc />
        public async Task<WebCallResult<BinanceFuturesUsdtOrder>> GetOrderAsync(string symbol, long? orderId = null, string? origClientOrderId = null, long? receiveWindow = null, CancellationToken ct = default)
        {
            ...
            return await _baseClient.SendRequestInternal<BinanceFuturesUsdtOrder>(_baseClient.GetUrl(queryOrderEndpoint, api, "1"), HttpMethod.Get, ct, parameters, true).ConfigureAwait(false);
        }
        ...
        /// <inheritdoc />
        public async Task<WebCallResult<BinanceFuturesUsdtCancelOrder>> CancelOrderAsync(string symbol, long? orderId = null, string? origClientOrderId = null, long? receiveWindow = null, CancellationToken ct = default)
        {
            ...
            var result = await _baseClient.SendRequestInternal<BinanceFuturesUsdtCancelOrder>(_baseClient.GetUrl(cancelOrderEndpoint, api, "1"), HttpMethod.Delete, ct, parameters, true).ConfigureAwait(false);
        ...
        /// <inheritdoc />
        public async Task<WebCallResult<IEnumerable<CallResult<BinanceFuturesUsdtCancelOrder>>>> CancelMultipleOrdersAsync(string symbol, List<long>? orderIdList = null, List<string>? origClientOrderIdList = null, long? receiveWindow = null, CancellationToken ct = default)
        {
            ...
            var response = await _baseClient.SendRequestInternal<IEnumerable<BinanceFuturesUsdtMultipleOrderCancelResult>>(_baseClient.GetUrl(cancelMultipleOrdersEndpoint, api, "1"), HttpMethod.Delete, ct, parameters, true).ConfigureAwait(false);

            if (!response.Success)
                return response.As<IEnumerable<CallResult<BinanceFuturesUsdtCancelOrder>>>(default);

            var result = new List<CallResult<BinanceFuturesUsdtCancelOrder>>();
            foreach (var item in response.Data)
            {
                result.Add(item.Code != 0
                    ? new CallResult<BinanceFuturesUsdtCancelOrder>(new ServerError(item.Code, item.Message))
                    : new CallResult<BinanceFuturesUsdtCancelOrder>(item));
            }

            return response.As<IEnumerable<CallResult<BinanceFuturesUsdtCancelOrder>>>(result);
        }
        ...
        /// <inheritdoc />
        public async Task<WebCallResult<BinanceFuturesUsdtOrder>> GetOpenOrderAsync(string symbol, long? orderId = null, string? origClientOrderId = null, long? receiveWindow = null, CancellationToken ct = default)
        {
            if (orderId == null && origClientOrderId == null)
                throw new ArgumentException("Either orderId or origClientOrderId must be sent");
            ...
            return await _baseClient.SendRequestInternal<BinanceFuturesUsdtOrder>(_baseClient.GetUrl(openOrderEndpoint, api, "1"), HttpMethod.Get, ct, parameters, true).ConfigureAwait(false);
        }
        ...
        /// <inheritdoc />
        public async Task<WebCallResult<IEnumerable<BinanceFuturesUsdtOrder>>> GetOpenOrdersAsync(string? symbol = null, int? receiveWindow = null, CancellationToken ct = default)
        {
            var parameters = new Dictionary<string, object>();
            parameters.AddOptionalParameter("recvWindow", receiveWindow?.ToString(CultureInfo.InvariantCulture) ?? _baseClient.Options.ReceiveWindow.TotalMilliseconds.ToString(CultureInfo.InvariantCulture));
            parameters.AddOptionalParameter("symbol", symbol);

            return await _baseClient.SendRequestInternal<IEnumerable<BinanceFuturesUsdtOrder>>(_baseClient.GetUrl(openOrdersEndpoint, api, "1"), HttpMethod.Get, ct, parameters, true, weight: symbol == null ? 40 : 1).ConfigureAwait(false);
        }
        ...
        /// <inheritdoc />
        public async Task<WebCallResult<IEnumerable<BinanceFuturesUsdtOrder>>> GetOrdersAsync(string symbol, long? orderId = null, DateTime? startTime = null, DateTime? endTime = null, int? limit = null, int? receiveWindow = null, CancellationToken ct = default)
        {
            ...
            return await _baseClient.SendRequestInternal<IEnumerable<BinanceFuturesUsdtOrder>>(_baseClient.GetUrl(allOrdersEndpoint, api, "1"), HttpMethod.Get, ct, parameters, true, weight: 5).ConfigureAwait(false);
        }
        ...
        /// <inheritdoc />
        public async Task<WebCallResult<IEnumerable<BinanceFuturesUsdtOrder>>> GetForcedOrdersAsync(string? symbol = null, AutoCloseType? closeType = null, DateTime? startTime = null, DateTime? endTime = null, int? receiveWindow = null, CancellationToken ct = default)
        {
            var parameters = new Dictionary<string, object>();
            parameters.AddOptionalParameter("recvWindow", receiveWindow?.ToString(CultureInfo.InvariantCulture) ?? _baseClient.Options.ReceiveWindow.TotalMilliseconds.ToString(CultureInfo.InvariantCulture));
            parameters.AddOptionalParameter("symbol", symbol);
            ...
            return await _baseClient.SendRequestInternal<IEnumerable<BinanceFuturesUsdtOrder>>(_baseClient.GetUrl(forceOrdersEndpoint, api, "1"), HttpMethod.Get, ct, parameters, true, weight: symbol == null ? 50 : 20).ConfigureAwait(false);
        }
